...
<head>
    ...
    <title>STORE - INSERT A USER</title>
</head>
            ...
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    <div class="form-container">
                        ...
                        <form class="form-horizontal" method="post" name="CreateUser" action="<?php echo base_url() . 'User/create'; ?>">
                            <div class="form-group">
                                <label>First Name</label>
                                <input type="text" name="fname" class="form-control" value="<?php echo set_value('fname'); ?>" placeholder="First Name">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="lname" class="form-control" value="<?php echo set_value('lname'); ?>" placeholder="Last Name">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-check form-group row">
                                        <input type="radio" class="form-check-input form-check-input" name="gender" id="radio2" value="female" <?php if (set_value('gender') == 'female') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                } ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" mame="telephone" class="form-control" placeholder="Phone Number">
                            </div>
                            <div class="form-group">
                            ...
                            <span class="signin-link" style="margin-top: 10px;">Already have an account? Click here to <a href="">Login</a></span>
