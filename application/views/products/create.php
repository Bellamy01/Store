...
<head>
    ...
    <title>PRODUCT - INSERT PRODUCT</title>
</head>
            ...
            <div class="col-md-6 offset-3 formees">
                <div class="row mb-3 mt-3">
                    <div class="col">
                        ...
                        <input type="text" name="productname" class="form-control" value="<?php echo set_value('productname'); ?>" placeholder="Enter Product">
                        <?php
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="brand" class="form-control" value="<?php echo set_value('brand'); ?>" placeholder="Enter Brand">
                        <?php
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="supplier" class="form-control" placeholder="Enter supplier" value="<?php echo set_value('supplier'); ?>">
                    <?php
